...
| `olympus_snar.csv` | 10fa18a8bc6af47d | 66 | Olympus datasets (Häse et al., *Mach. Learn.: Sci. Technol.* 2, 035021 (2021); github.com/aspuru-guzik-group/olympus, MIT). Header added from `dataset_snar/config.json`: residence_time, ratio, concentration, temperature → e_factor (minimize). |
| `olympus_fullerenes.csv` | 21ccb3b8590ad867 | 246 | Same source, `dataset_fullerenes`: reaction_time, sultine, temperature → product_mole_percent (maximize). |
